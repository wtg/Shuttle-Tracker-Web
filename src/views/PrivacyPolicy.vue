      ...
      <div>
        <div class="row">
          <div class="col" :class="{'text-white': isDarkMode}" style="max-width: 1140px; ">
            ...
            <button class="collapsible" :class="{'text-white': isDarkMode}" @click="toggleCollapsible(1)">Logging
            ...
            <button class="collapsible" :class="{'text-white': isDarkMode}" @click="toggleCollapsible(2)">Analytics
