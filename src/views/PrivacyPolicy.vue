      ...
      <div>
        <div class="row">
          <div class="col" :class="{'text-white': isDarkMode}" style="max-width: 1140px; ">
            ...
            <h4>Updated Novemeber 3, 2023</h4>
            <p> 
            ...
            <button class="collapsible" :class="{'text-white': isDarkMode}" @click="toggleCollapsible(0)">Location</button>
            <div class="content" :class="{'show': isCollapsibleOpen[0]}">
            <p>
            ...
            <button class="collapsible" :class="{'text-white': isDarkMode}" @click="toggleCollapsible(1)">Logging</button>
            <div class="content" :class="{'show': isCollapsibleOpen[1]}">
            <p>
            ...
            <button class="collapsible" :class="{'text-white': isDarkMode}" @click="toggleCollapsible(2)">Analytics</button>
            <div class="content" :class="{'show': isCollapsibleOpen[2]}">
            <p>
              If you opt in to analytics, then Shuttle Tracker will send anonymous usage data to our server. These data include your app settings, feature usage frequency, and other similar metrics. No analytics data are ever collected unless you explicitly opt in. You can see a record of recently uploaded analytics reports or opt-in status in Settings > Logging & Analytics.
            </p>
            </div>
