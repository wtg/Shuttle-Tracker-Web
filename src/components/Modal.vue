<template>
  <b-modal title="Welcome to the new Shuttle Tracker!" :header-text-variant="headerTextColor" :footer-bg-variant="theme"
    ...
    <div :class="[{'text-white': isDarkMode}, {'bg-dark':isDarkMode}]"> You're using the new Web interface for the <i>
      new </i> Shuttle Tracker. We've completely overhauled every component to bring superior accuracy.
    </div>
    <div class="my-2" :class="[{'text-white': isDarkMode}, {'bg-dark':isDarkMode}]"> Green Buses indicates accurate
    ...
    <div class="my-2" :class="[{'text-white': isDarkMode}, {'bg-dark':isDarkMode}]"> If you use iPhone, then you can
